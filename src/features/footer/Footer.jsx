...
import { useTheme, useMediaQuery, Grid, Button, Box, Typography } from '@mui/material';

const Footer = () => {
  const theme = useTheme()
  const isMobile = useMediaQuery(theme.breakpoints.down('md'))
  return (
    <Grid container sx={{ backgroundColor: !isMobile ? 'rgb(245, 139, 98)' : '#cd6444 ', padding: '50px 50px', color: '#000' }} className={style.FooterContain}>
